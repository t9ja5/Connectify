...
let ed = document.getElementById("endCall");
...
function addParticipantToList(data) {
  ...
  colIcon.innerHTML = `${data.displayName}`;
  participantTemplate.appendChild(colIcon);

  //name
  let content = document.createElement("button");
  content.className = "rmbt";
      let icon = document.createElement("i");
        icon.className = "material-icons";
        icon.textContent = "cancel";
        icon.style.position = "relative" ; 
        icon.style.color = "white"; // Replace "face" with the name of the desired icon;
        icon.style.top = "2px";
  ...
  if (data.isHost) {
    // Show the "Remove" button only for the host
  ...
  // let mtall = document.createElement("button");
  // mtall.className = "mtbt";
  // mtall.innerHTML = "Mute";
  // participantTemplate.appendChild(mtall);
  // participants.push({ id, displayName });
 
  console.log("add part id");
  // console.log(id);
...
// const muteAllBtn = document.getElementById("mtall");

//   muteAllBtn.addEventListener("click", () => {
//     const participants = meeting.participants;
//     const participant = participants.get(localParticipan);
...
function handleRaiseHand(conten) {
...
document.addEventListener("DOMContentLoaded", () => {
  document.getElementById("create-meet-btn").addEventListener("click", () => {
    ishost = true;
    joinMeeting(true);
    // Create meet logic here
  });

  document.getElementById("join-meet-btn").addEventListener("click", () => {
    ishost = false;
    joinMeeting(false);
    // Join meet logic here
  });
});
