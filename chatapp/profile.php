...
<body>
  ...
  <div class="main">
    ...
    <div class="area">
      ...
      <div class="vpnbtn">
                <a href="vpn-feature/index.html"><button>VPN</button></a>
               </div>
      <hr>
      <div class="title">
        ...
        <div id="updateProfilePic" class="picModal">
         <div class="picModal-content">
           <button id="close">&times;</button>
           <h2>Update Profile Picture</h2>
           <img src="" style="display:none" id="profile_img" alt="Profile Image Preview">
           <form id="postForm" method="post" action="php/update-profile-pic.php" enctype="multipart/form-data">
             <input type="file" name="profile_img" id="select_profile_image" required /><br />
             <strong>Only JPG, JPEG, and PNG are allowed.</strong>
             <br />
          ...
          <div class="post" data-post-id="<?php echo $post['id']; ?>" >
            ...
            <div class="actions" >
              ...
              <?php 
                ...
                <div class="dropdown">
                  <span class="material-icons more-options delete-post" data-post-id="<?php echo $post['id']; ?>">delete</span>
                </div>
        ...
        <div class="reels" id="reelsSection">
          ...
          <div class="reel" data-reel-id="<?php echo $reel['id']; ?>">
           ...
           <div class="reel_actions">
              ...
              <div class="dropdown">
                <span class="material-icons more-options delete-reel" data-reel-id="<?php echo $reel['id']; ?>">delete</span>
              </div>
  ...
  <script src="javascript/delete_reel.js"></script>  
  <script src="javascript/update_profile_pic.js"></script>  
</body>
